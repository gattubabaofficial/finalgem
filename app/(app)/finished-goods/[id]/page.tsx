...
export default function FinishedGoodDetailPage({ params }: { params: Promise<Params> }) {
  ...
  const [form, setForm] = useState({
    ...
    lessWeight: "0", pieces: "", shape: "", size: "",
    lines: "", lineLength: "", descriptionRef: ""
  });
  ...
  useEffect(() => { fetchFinishedGood(); }, [id]);
            ...
            <div className="card border-0 shadow-premium rounded-5 overflow-hidden mb-4 bg-white">
              <div className="card-body p-5">
                <div className="d-flex align-items-center gap-3 mb-5">
                  ...
                  <h4 className="fw-extrabold m-0 text-navy uppercase tracking-widest">Inventory Profile</h4>
                </div>
                ...
                <div className="row g-5">
                  ...
                  <div className="col-md-6">
                    <Field label="Stock Inbound Date" icon={<Calendar size={18} />}>
                      <input 
                  ...
                  <div className="col-md-6">
                    <Field label="Vendor / Source" icon={<User size={18} />}>
                      <input 
                        readOnly={!isEditMode}
                  ...
                  <div className="col-md-6">
                    <Field label="Finished Item Name" icon={<Tag size={18} />}>
                      <input 
                        readOnly={!isEditMode}
                        value={form.itemName} 
            ...
            <div className="card h-100 border-0 shadow-premium rounded-5 bg-emerald-subtle-25">
              <div className="card-body p-5">
                ...
                <div className="row g-4">
                  ...
                  <div className="col-md-4">
                    <ModernBadgeStat label="Piece Count" value={form.pieces} isEdit={isEditMode} field="pieces" onChange={f} />
                  </div>
                  <div className="col-md-6">
                    <ModernSmallField label="Strand Count" value={form.lines} isEdit={isEditMode} onChange={(v) => f("lines", v)} accent="emerald" />
                  </div>
                  <div className="col-md-6">
                    <ModernSmallField label="Total Strand L." value={form.lineLength} isEdit={isEditMode} onChange={(v) => f("lineLength", v)} accent="emerald" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="card border-0 shadow-premium rounded-5 bg-white mb-4 overflow-hidden">
               <div className="card-body p-4">
                <div className="d-flex align-items-center gap-3 mb-4">
                  ...
                  <h6 className="fw-extrabold m-0 text-navy uppercase tracking-wider">Yield Metrics</h6>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <ModernStatRow label="Loss Buffer" value={parseFloat(form.lessWeight || "0").toFixed(3)} unit={form.weightUnit} isEdit={isEditMode} field="lessWeight" onChange={f} />
